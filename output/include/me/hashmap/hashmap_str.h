...
/*   Updated: 2023/12/08 16:52:50 by maiboyer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef size_t (*t_hash_str_fn)(t_str *key);
...
t_hashmap_str *new_hashmap_str(t_hash_str_fn hash,
											   t_eq_str_fn	 cmp,
											   t_drop_str_fn drop);
t_hashmap_str *new_hashmap_with_buckets_str(
	t_hash_str_fn hash, t_eq_str_fn cmp,
	t_drop_str_fn drop, size_t cap);
