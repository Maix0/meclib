...
/*   Updated: 2023/12/10 20:00:32 by maix             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef void		(*t_hash_bytes)(void *hasher, t_u8 *bytes, t_usize count);
typedef t_u64		(*t_hash_finish)(void *hasher);

typedef struct s_hasher
{
	void			*hasher;
	t_hash_bytes	hash_bytes;
	t_hash_finish	finish;

}					t_hasher;

void				hasher_write_bytes(t_hasher *hasher, t_u8 *bytes,
						t_usize count);
